...
const Chat = () => {
  ...
  useEffect(() => {
    if (location.state && location.state.currentUser) {
      ...
      setFriends(
        Array.isArray(location.state.friends) ? location.state.friends : []
      );
    } else {
      ...
      if (savedData) {
        try {
          ...
          setFriends(
            Array.isArray(parsedData.friends) ? parsedData.friends : []
          );
        } catch (e) {
              ...
              gun
                ...
                .put(
                  ...
                  (innerAck) => {
                    if (innerAck.err) {
                      console.error(
                        "Failed to add friend (put method):",
                        innerAck.err
                      );
                      setErrorMessage(
                      ...
                      console.log(
                        "Friend added successfully via fallback method"
                      );
                      toggleModal();
                    }
                  }
